...
<body>
    <nav class="navbar navbar-light navbar-expand-md py-3">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"><span class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon" style="background: rgba(121,153,167,0.66);"><svg class="bi bi-cup-straw" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    </svg></span><span>Cadastro de Produto</span></a>
            <ul class="navbar-nav" style="width: 279.472px;margin-right: 0px;">
            <button><a  class="btn btn-primary d-block w-100" href="listagem.php">Listagem</a></button>
                    ...
                    <div class="card mb-5">
                        <div class="card-body p-sm-5">
                            ...
                            <form action="form.php" method="POST">
                                <div class="mb-3"><input id="name-2" class="form-control" type="text" name="nome" placeholder="Nome" required/></div>
                                <div class="mb-3"><input id="marca" class="form-control" type="text" name="marca" placeholder="Marca" required /></div>
                                <div class="mb-3"><input id="estoque" class="form-control" type="text" name="estoque" placeholder="Estoque" required/></div>
                                <div class="mb-3"><input id="preco" class="form-control" type="text" name="preco" placeholder="Preço" required/></div>
                                <div class="mb-3"><input id="referencia" class="form-control" type="text" name="referencia" placeholder="Referência" required/></div>

                                <div><input class="btn btn-primary d-block w-100" type="submit" name="submit" id="submit"></div>
...
<?php 
 ...
 if( (isset($_POST['nome'])) && (isset($_POST['marca']))  && (isset($_POST['estoque'])) && (isset($_POST['preco'])) && (isset($_POST['referencia'])))  {
    $host = "localhost";
    $user = "root";
    $pwd = "matrix";
    $bd = "diogo";
    ...
    $query = "insert into produtos (nome,marca,estoque,preco,referencia) values ('$nome','$marca','$estoque','$preco','$referencia')";
